interface ClaseRecuperacion {
  nombre?: string | null;
  nivel_clase?: string | null;
  tipo_clase?: string | null;
}

interface RecuperacionPendienteFicha {
  id?: string;
  clase_id?: string | null;
  fecha_falta?: string | null;
  observaciones?: string | null;
  clases?: ClaseRecuperacion | null;
}

interface FichaAlumnoTabRecuperacionesProps {
  recuperaciones: RecuperacionPendienteFicha[];
  /** Pasado desde la página; reservado por si el tab necesita contexto del alumno */
  alumnoId?: string | null;
  onCompletar?: (recuperacion: RecuperacionPendienteFicha) => void;
  onAsignar?: (recuperacion: RecuperacionPendienteFicha) => void;
  onCancelar?: (recuperacion: RecuperacionPendienteFicha) => void;
}
...
export default function FichaAlumnoTabRecuperaciones({
  ...
  onAsignar,
  onCancelar,
}: FichaAlumnoTabRecuperacionesProps) {
  const recuperacionesArray = recuperaciones;
