...
interface ProfesorHistorialProps {
  eventos: EventoHistorial[];
  onSelectEvento?: (evento: EventoHistorial) => void;
}

export default function ProfesorHistorial({
  eventos,
  onSelectEvento,
}: ProfesorHistorialProps) {
  const [eventoSeleccionado, setEventoSeleccionado] =
    useState<EventoHistorial | null>(null);
              ...
              <div className='flex items-center justify-between'>
                <div className='flex-1'>
                  ...
                  <p className='text-xs text-gray-500 dark:text-dark-text2'>
                    Haz clic en "Ver detalle" para ver alumnos, temática y
                    ejercicios
                  </p>
                </div>
