/** Alineado con `InternaMesItem` de `useInternasMes` */
interface InternasMesListadoItem {
  id: string;
  nombre: string;
  fecha: string;
...
interface PagosInternasHoyProps {
  items: InternasMesListadoItem[];
  onTogglePago?: (item: InternasMesListadoItem) => void;
}

export default function PagosInternasHoy({
  items,
  onTogglePago,
}: PagosInternasHoyProps) {
