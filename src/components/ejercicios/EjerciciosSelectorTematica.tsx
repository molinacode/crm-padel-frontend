...
interface EjerciciosSelectorTematicaProps {
  mostrar: boolean;
  onClose: () => void;
  clasesDisponibles: ClaseOpcion[];
  profesoresDisponibles: ProfesorOpcion[];
  claseSeleccionada: string;
  setClaseSeleccionada: (id: string) => void;
  profesorSeleccionado: string;
  setProfesorSeleccionado: (valor: string) => void;
  onContinuar: () => void;
}
...
export default function EjerciciosSelectorTematica({
  ...
  onContinuar,
}: EjerciciosSelectorTematicaProps) {
