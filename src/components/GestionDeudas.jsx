...
export default function GestionDeudas({ onClose }) {
  ...
  if (loading)
    return (
      <LoadingSpinner size='medium' text='Cargando alumnos con deuda...' />
    );
            ...
            <div className='flex items-center gap-4'>
              ...
              <div>
                ...
                <p className='text-gray-600 dark:text-dark-text2'>
                  Alumnos con deudas pendientes ({alumnosConDeuda.length})
                </p>
              </div>
            </div>
            <button
          ...
          {alumnosConDeuda.length === 0 ? (
            ...
            <div className='space-y-4'>
              {alumnosConDeuda.map(alumno => (
                <div
                  key={alumno.id}
                  className='bg-gray-50 dark:bg-gray-800/30 rounded-xl p-4 border border-gray-200 dark:border-dark-border'
                >
                  <div className='flex items-center justify-between'>
