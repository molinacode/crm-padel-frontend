type CardColor = 'blue' | 'purple' | 'orange' | 'indigo';
...
interface InstalacionesStatsCardProps {
  titulo: string;
  color: CardColor;
  estadisticas?: CardStats;
  onClick: () => void;
}
...
export default function InstalacionesStatsCard({
  ...
  const colorClasses: Record<CardColor, { bg: string; text: string; border: string }> = {
    blue: {
