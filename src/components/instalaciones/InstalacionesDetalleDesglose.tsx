interface ClaseDia {
  nombre: string;
  tipo: string;
  tipoOperacion: 'ingreso' | 'gasto' | string;
  valor: number;
}

interface DiaDesglose {
  ingresos: number;
  gastos: number;
  clases: ClaseDia[];
}

interface InstalacionesDetalleDesgloseProps {
  eventosPorDia: Record<string, DiaDesglose>;
...
export default function InstalacionesDetalleDesglose({
  eventosPorDia,
  formatearFecha,
}: InstalacionesDetalleDesgloseProps) {
