...
import MobileGastoCard from '../common/MobileGastoCard';

interface GastoMaterialItem {
  id?: string | number;
...
interface ListaGastosMaterialProps {
  gastos?: GastoMaterialItem[];
  onEditar?: (gasto: GastoMaterialItem) => void;
  onEliminar?: (gasto: GastoMaterialItem) => void;
}

export default function ListaGastosMaterial({
  gastos = [],
  onEditar,
  onEliminar,
}: ListaGastosMaterialProps) {
  ...
  // Vista móvil: usar componentes reutilizables
  if (isMobile) {
    return (
