...
const colorClasses: Record<ActionColor, string> = {
  ...
  fuchsia:
    'border-fuchsia-200 dark:border-fuchsia-800 bg-fuchsia-50 dark:bg-fuchsia-900/20 hover:bg-fuchsia-100 dark:hover:bg-fuchsia-900/30',
};
    ...
    <>
      ...
      >
        ...
        {accionesAgrupadas.map((group, groupIndex) => (
          <div
            key={groupIndex}
            className={`px-6 py-4 ${groupIndex > 0 ? 'border-t border-gray-200 dark:border-dark-border' : ''}`}
          >
            {group.category && (
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      {accion.icon && <span className="text-2xl">{accion.icon}</span>}
                      <div className="text-left">
                        <div className={`font-semibold ${textColorClass}`}>{accion.label}</div>
                        {accion.badge && (
