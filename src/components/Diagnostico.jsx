...
import { diagnosticarBaseDeDatos, probarConsultasPaginas } from '../utils/diagnostico';
...
export default function Diagnostico() {
    ...
    const ejecutarDiagnostico = async () => {
        ...
        try {
            ...
            setResultados({ errores: [`Error ejecutando diagnóstico: ${error.message}`] });
        } finally {
            setEjecutando(false);
        }
    };
    ...
    return (
        <div className="p-6 bg-white dark:bg-dark-surface rounded-lg shadow-lg">
            ...
            <p className="text-gray-600 dark:text-dark-text2 mb-6">
                Este diagnóstico verificará el estado de la base de datos y las consultas principales.
