...
interface EventoParaAsignar {
  alumnoRecuperacion?: boolean;
  [key: string]: unknown;
}

interface ModalAsignarAlumnosProps {
  eventoParaAsignar: EventoParaAsignar | null;
  onClose: () => void;
  onSuccess: () => void;
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-sm text-purple-700 dark:text-purple-400">
                    Estás asignando una clase de recuperación. El alumno tiene derecho a recuperar esta clase por una falta justificada.
                  </p>
                </div>
              </div>
            </div>
