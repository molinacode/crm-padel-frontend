...
interface ClaseItem {
  ...
  eventos_proximos?: EventoProximo[];
}
                    ...
                    {clase.eventos_proximos && clase.eventos_proximos.length > 0 && (
                      <div className="mt-3 pt-3 border-t border-gray-200 dark:border-dark-border">
                        <div className="flex items-center gap-2 text-sm flex-wrap">
                          ...
                          <span className="text-gray-400">•</span>
                          <span
                            className="text-xs px-1.5 py-0.5 bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 rounded font-mono"
                            title="ID del evento en tabla eventos_clase"
                          >
                            EvID: {clase.eventos_proximos[0].id}
                          </span>
                          <span className="text-xs px-1.5 py-0.5 bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 rounded">
                            {clase.eventos_proximos.length} evento
                            {clase.eventos_proximos.length !== 1 ? 's' : ''}
                          </span>
                        </div>
                      </div>
                    )}
