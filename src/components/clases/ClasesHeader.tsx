          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 sm:gap-4 text-xs sm:text-sm">
              <div className="flex items-center space-x-2">
                <div className="w-4 h-4 border-l-4 border-purple-500 bg-purple-50 dark:bg-purple-900/30 rounded" />
                <span className="text-gray-700 dark:text-dark-text2">🎯 Particular</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-4 h-4 border-l-4 border-green-500 bg-green-50 dark:bg-green-900/30 rounded" />
                <span className="text-gray-700 dark:text-dark-text2">🏠 Interna</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-4 h-4 border-l-4 border-orange-500 bg-orange-50 dark:bg-orange-900/30 rounded" />
                <span className="text-gray-700 dark:text-dark-text2">🏫 Escuela</span>
              </div>
              <div className="flex items-center space-x-2">
                <div className="w-4 h-4 border-l-4 border-blue-500 bg-blue-50 dark:bg-blue-900/30 rounded" />
