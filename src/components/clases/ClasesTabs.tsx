interface ClasesTabsProps {
  tabActiva: 'proximas' | 'calendario' | 'historial' | 'nueva' | string;
  setTabActiva: (tab: string) => void;
}

export default function ClasesTabs({ tabActiva, setTabActiva }: ClasesTabsProps) {
  const tabs = [
