...
interface ClaseAlumnoRow {
  id: string;
  clases: ClaseAsignada;
}

interface SeguimientoClasesListProps {
  clases?: ClaseAlumnoRow[];
}

export default function SeguimientoClasesList({ clases = [] }: SeguimientoClasesListProps) {
  return (
