...
interface SeguimientoHistorialProps {
  seguimientos?: SeguimientoItem[];
  onCrear: () => void;
}

export default function SeguimientoHistorial({
  seguimientos = [],
  onCrear,
}: SeguimientoHistorialProps) {
  return (
              ...
              <div className="flex justify-between items-start mb-4">
                <div>
                  ...
                  {seguimiento.nivel_actual && (
                    <p className="text-sm text-gray-600 mt-1">Nivel actual: {seguimiento.nivel_actual}</p>
                  )}
                </div>
                <span
