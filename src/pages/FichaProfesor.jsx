...
export default function FichaProfesor() {
  ...
  const obtenerProximasClases = () => {
    ...
    return proximasClases.sort((a, b) => new Date(a.evento.fecha) - new Date(b.evento.fecha));
  };
    ...
    return (
      <div className="flex items-center justify-center min-h-96">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-dark-text2">Cargando datos del profesor...</p>
        </div>
      </div>
    );
  }
  ...
  if (!profesor) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="text-lg font-medium text-gray-900 dark:text-dark-text mb-2">Profesor no encontrado</h3>
        <p className="text-gray-500 dark:text-dark-text2 mb-6">El profesor que buscas no existe o ha sido eliminado</p>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="text-gray-900">{profesor.nombre} {profesor.apellidos}</p>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-gray-500">Edad:</span>
                      <p className="text-gray-900">{calcularEdad(profesor.fecha_nacimiento)} años</p>
                    </div>
                    <div>
                      <span className="text-sm font-medium text-gray-500">Teléfono:</span>
                      <p className="text-gray-900">{profesor.telefono || 'No especificado'}</p>
                    </div>
                    <div>
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      <span className="text-sm font-medium text-gray-500">Nivel de experiencia:</span>
              ...
              {profesor.observaciones && (
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <p className="text-gray-700 whitespace-pre-wrap">{profesor.observaciones}</p>
                </div>
              )}
            </div>
          )}
            ...
            <div className="space-y-6">
              ...
              {clases.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500">No hay clases asignadas a este profesor</p>
                </div>
              ) : (
          ...
          {activeTab === 'horarios' && (
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm text-gray-500">{proximasClases.length} clase{proximasClases.length !== 1 ? 's' : ''}</span>
              </div>
              ...
              {proximasClases.length === 0 ? (
                ...
                <div className="grid gap-4">
                  {proximasClases.slice(0, 10).map((clase, index) => (
                    <div key={`${clase.id}-${clase.evento.id}`} className="bg-gray-50 rounded-lg p-4">
                      <div className="flex justify-between items-start">
                        <div>
                          <h4 className="font-semibold text-gray-900">{clase.nombre}</h4>
                          <p className="text-sm text-gray-600">{clase.nivel_clase} • {clase.tipo_clase}</p>
                        ...
                        <div className="text-right">
                          ...
                          <p className="text-xs text-gray-500 mt-1">
                            {clase.evento.estado === 'cancelada' ? '❌ Cancelada' : '✅ Programada'}
                          </p>
                        </div>
                      </div>
                    </div>
