...
export default function OtrosAlumnos() {
    ...
    const cargarOtrosAlumnos = async () => {
        ...
        `);
            ...
            console.log('📋 Alumnos asignados a clases internas encontrados:', alumnosInternos.length);
                ...
                <div className="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-green-800 dark:text-green-200">
                            Estos alumnos están asignados a clases internas y no requieren pago directo.
                            Sus clases están cubiertas por otros medios de pago.
                        </p>
                    </div>
                </div>
            </div>
