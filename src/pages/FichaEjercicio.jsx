  ...
  if (!ejercicio) {
    return (
      <div className="text-center py-12">
        ...
        <h3 className="text-lg font-medium text-gray-900 dark:text-dark-text mb-2">Ejercicio no encontrado</h3>
        <p className="text-gray-500 dark:text-dark-text2 mb-6">El ejercicio que buscas no existe o ha sido eliminado</p>
      ...
      <div className="bg-white dark:bg-dark-surface rounded-lg shadow-sm border border-gray-200 dark:border-dark-border">
        ...
        <div className="p-6">
          ...
          {activeTab === 'info' && (
            <div className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900">
                        {ejercicio.duracion_minutos ? `${ejercicio.duracion_minutos} minutos` : 'No especificada'}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">🎾 Material y Descripción</h3>
                  <div className="space-y-3">
                    <div>
                    ...
                    <div>
                      ...
                      <p className="text-gray-900">{ejercicio.material_necesario || 'No especificado'}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {ejercicio.observaciones && (
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <p className="text-gray-700 whitespace-pre-wrap">{ejercicio.observaciones}</p>
                </div>
              )}
            </div>
          )}
          ...
          {activeTab === 'instrucciones' && (
            <div className="space-y-6">
              <div className="bg-gray-50 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-gray-900 mb-4">📋 Instrucciones Paso a Paso</h3>
                <div className="prose max-w-none">
                  <p className="text-gray-700 whitespace-pre-wrap leading-relaxed">
                    {ejercicio.instrucciones || 'No hay instrucciones detalladas disponibles.'}
                  </p>
                </div>
              </div>
              ...
              {ejercicio.variaciones && (
                <div className="bg-gray-50 rounded-lg p-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">🔄 Variaciones</h3>
                  <div className="prose max-w-none">
                    <p className="text-gray-700 whitespace-pre-wrap leading-relaxed">
                      {ejercicio.variaciones}
                    </p>
          ...
          {activeTab === 'clases' && (
            <div className="space-y-6">
              <div className="flex justify-between items-center">
                <h3 className="text-lg font-semibold text-gray-900">📅 Clases que usan este ejercicio</h3>
                <span className="text-sm text-gray-500">{clasesAsignadas.length} clase{clasesAsignadas.length !== 1 ? 's' : ''}</span>
              </div>

              {clasesAsignadas.length === 0 ? (
                <div className="text-center py-8">
                  <div className="text-4xl mb-4">📅</div>
                  <p className="text-gray-500">Este ejercicio no está asignado a ninguna clase</p>
                </div>
              ) : (
